              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    SizedBox(height:20),
                    Text("Contact No.:",style: TextStyle(fontFamily: "Poppins_Bold", fontSize: 15, color: Color.fromRGBO(19, 59, 78, 1))
                    ),
                    SizedBox(height:20),
                    ...
                    SizedBox(height:20),
                    Text("Aadhar No.:",style: TextStyle(fontFamily: "Poppins_Bold", fontSize: 15, color: Color.fromRGBO(19, 59, 78, 1))
                    ),
                    SizedBox(height:20),
  ...
  Widget DistributorDialog(context)  {
    ...
    return Container(
        ...
        child: Column(
          children: [
            Container(
              child: Text("Dealer Address",style: TextStyle(fontFamily: "Poppins_Bold"),),
            ),
            Container(
              padding: EdgeInsets.symmetric(horizontal: 20),
              child: Text(user.address!,style: TextStyle(fontFamily: "Poppins"),),
            ),
            Container(
              margin: EdgeInsets.only(top: 20),
              child: Text("Select Distributor",style: TextStyle(fontFamily: "Poppins_Bold"),),
            ),
            Container(
                        ...
                        return InkWell(
                            ...
                            child: Card(
                              ...
                              child: Column(
                                children: [
                                  Container(
                                      child: Text(distributors[index].orgName!,textAlign: TextAlign.left,style: TextStyle(fontSize: 15),),
                                  ...
                                  Container(
                                      ...
                                      child: Text(distributors[index].address!,style: TextStyle(fontSize: 15))
                                  ),
                                ],
                              ),
                            )
