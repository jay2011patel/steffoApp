  ...
  Widget ChallanListBody(){
    return Container(
        ...
        child: SingleChildScrollView(
            ...
            crossAxisAlignment: CrossAxisAlignment.center,
              children: [
                Container(
                  ...
                  child: Row(
                    children: [
                      Text("Order Id:",style: TextStyle(fontFamily: "Poppins_Bold"),),
                      Padding(
          ...
          child: Column(
              children: [
                Center(child: Text("Challan",style: TextStyle(fontFamily: "Poppins_Bold"),)),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Container(child: Text("Challan ID:",textAlign: TextAlign.left,style: TextStyle(fontFamily: "Poppins_Bold"),)),
              Container(
                  padding: EdgeInsets.only(left: 65),
                  child: Text("987611",textAlign: TextAlign.center,style: TextStyle(fontFamily: "Poppins_Bold"),))
            ],
          ),
          Container(
            child: Row(
              children: [
                ...
                Container(
                  child: Text("Transporter Name:",style: TextStyle(fontFamily: "Roboto"),),
                  padding: EdgeInsets.only(top: 5,bottom: 5,right:20 ),
                ),

                Expanded(child: Text(trp_name,overflow: TextOverflow.ellipsis,maxLines: 3,))
              ],
            ),
          ),
          Container(
