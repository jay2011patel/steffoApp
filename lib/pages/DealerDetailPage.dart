...
class DealerDetailPage extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    return DealerDetailContent(user: user,);
  }
              ...
              child:Column(
                children: [
                  Container(
                    ...
                    child:Text(widget.user.orgName!,style: GoogleFonts.poppins(textStyle: TextStyle(fontWeight: FontWeight.bold,fontSize: 20,color: Colors.blue)),)
                  ),
                  Container(
                    width: MediaQuery.of(context).size.width,
